...
- The photographer-facing workflow must be no-code. Do not require editing HTML, CSS, JavaScript, Vercel settings, or image URLs for normal profile/contact/photo changes.
...
Do not rebuild this as a detached enterprise dashboard unless explicitly requested. The core requirement is a photographer editing the live portfolio in context without code.
